...
#define DEL_DIR_OR_FILE_OK "delete dir or file ok"
#define DEL_DIR_OR_FILE_FAILURED "delete dir or file failured"
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_DEL_DIR_OR_FILE_REQUEST,  //删除目录请求
    ENUM_MSG_TYPE_DEL_DIR_OR_FILE_RESPOND,  //删除目录回复
    ...
    ENUM_MSG_TYPE_SHARE_FILE_NOTE_AGGREE,//好友同意接受分享的文件
    ENUM_MSG_TYPE_SHARE_FILE_NOTE_REFUSE,//好友拒绝接受分享的文件
