...
{
    // 读取配置文件rpcserver的信息
    std::string ip = QlrpcApplication::GetInstance().GetConfig().Load("rpcserverip");
    uint16_t port = atoi(QlrpcApplication::GetInstance().GetConfig().Load("rpcserverport").c_str());
